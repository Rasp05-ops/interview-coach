...
// use a persistent database service before relying on session history in production.
const DATA_DIR = process.env.VERCEL ? "/tmp/interview-coach" : path.join(process.cwd(), ".data");
